...
type Response struct {
	...
	FinancingGroup            string           `json:"financing_group,omitempty"`
	ApplicationFee            float64          `json:"application_fee,omitempty"`
	CampaignID                int              `json:"campaign_id,omitempty"`
	AcquirerReconciliation    []map[string]any `json:"acquirer_reconciliation,omitempty"`
	AccountsInfo              map[string]any   `json:"accounts_info,omitempty"`
	Tags                      map[string]any   `json:"tags,omitempty"`
	ChargesDetails            []map[string]any `json:"charges_details,omitempty"`
}
