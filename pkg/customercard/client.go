// This package is useful for customer & cards feature and has the following services:
...
type Client interface {
	// Create a new card to the customer.
	...
	// Get a customer card by customer id and card id.
	...
	// Update a customer card by customer id and card id.
	...
	// Delete a customer card by customer id and card id.
	...
	// List all customer's cards by id.
